...
namespace TutorialMod.Content.Items.Armor
{
    ...
    public class MalvadiumHelm : ModItem
    {
        ...
        {
            return body.type == ModContent.ItemType<MalvadiumBreastplate>() && legs.type == ModContent.ItemType<MalvadiumLeggings>();
        }
        ...
        public override void UpdateArmorSet(Player player)
        {
            ...
            player.lavaMax = 420; // default is 300 (5 seconds)
