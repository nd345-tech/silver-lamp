...
namespace TutorialMod.Content.Items.Accessories
{
    ...
    public class MalvadiumShield : ModItem
    {
        ...
        public override void PreUpdateMovement()
        {
            ...
            if (CanUseDash() && DashDir != -1 && DashDelay == 0)
            {
                ...
                for (int i = 0; i < numProjectiles; i++)
                {
                    ...
                    Projectile.NewProjectile(
                        ...
                        Player.Center,
                        velocity,
                        ProjectileID.BlackBolt, // change if you want custom
                        20, // damage (tune this)
                        2f,
                        Player.whoAmI
                    );
            ...
            { // dash is active
              ...
              // Here we take advantage of "player.eocDash" and "player.armorEffectDrawShadowEOCShield" to get the Shield of Cthulhu's afterimage effect
                Player.immune = true;
                Player.npcTypeNoAggro[Main.npc.Length] = true;
            ...
            {
                Player.immune = false;
                Player.npcTypeNoAggro[Main.npc.Length] = false;
            }
        }
