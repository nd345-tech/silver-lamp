...
{
    public class MalvadiumArrow : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<Projectiles.MalvadiumArrow>(); // The projectile that weapons fire when using this item as ammunition.
