...
{
    public class MalvadiumOre : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            Main.tileOreFinderPriority[Type] = 900; // Metal Detector value, see https://terraria.wiki.gg/wiki/Metal_Detector
    ...
    public class MalvadiumOreSystem : ModSystem
    {
        public static LocalizedText MalvadiumOrePassMessage { get; private set; }
        public static LocalizedText BlessedWithMalvadiumOreMessage { get; private set; }

        public override void SetStaticDefaults()
        {
            MalvadiumOrePassMessage = Mod.GetLocalization($"WorldGen.{nameof(MalvadiumOrePassMessage)}");
            //BlessedWithMalvadiumOreMessage = Mod.GetLocalization($"WorldGen.{nameof(BlessedWithMalvadiumOreMessage)}");
        }
        ...
        //public void BlessWorldWithMalvadiumOre()
        //{
        ...
        //        {
        //            Main.NewText(BlessedWithMalvadiumOreMessage.Value, 50, 255, 130);
        //        }
        //        else if (Main.netMode == NetmodeID.Server)
        //        {
        //            ChatHelper.BroadcastChatMessage(BlessedWithMalvadiumOreMessage.ToNetworkText(), new Color(50, 255, 130));
        //        }
        ...
        //            WorldGen.OreRunner(i, j, WorldGen.genRand.Next(5, 9), WorldGen.genRand.Next(5, 9), (ushort)ModContent.TileType<MalvadiumOre>());
        //        }
        //    });
        //}
        ...
        public override void ModifyWorldGenTasks(List<GenPass> tasks, ref double totalWeight)
        {
            ...
            if (ShiniesIndex != -1)
            {
                ...
                tasks.Insert(ShiniesIndex + 1, new ExampleOrePass("Malvadium Mod Ores", 237.4298f));
            }
        }
    }
    ...
    public class ExampleOrePass : GenPass
    {
        ...
        protected override void ApplyPass(GenerationProgress progress, GameConfiguration configuration)
        {
            ...
            progress.Message = MalvadiumOreSystem.MalvadiumOrePassMessage.Value;
            ...
            for (int k = 0; k < (int)(Main.maxTilesX * Main.maxTilesY * 6E-05); k++)
            {
                ...
                WorldGen.TileRunner(x, y, WorldGen.genRand.Next(5, 10), WorldGen.genRand.Next(2, 6), ModContent.TileType<MalvadiumOre>());
            }
        }
    }
}
